...
const UpcomingEvents = () => {
    ...
    const events = [
        {
            ...
            description: "Explore the future of the decentralized web and immersive digital experiences with industry pioneers.",
            imageUrl: "https://images.unsplash.com/photo-1641353989282-2b8a4a2a4b3f?q=80&w=2070&auto=format&fit=crop",
        },
        {
            date: "NOV 15 2025",
            title: "AI in Design Summit",
            location: "San Francisco, CA",
            description: "A deep dive into how artificial intelligence is revolutionizing the creative process for designers.",
        ...
        },
        {
            ...
            description: "Witness the latest breakthroughs in automation and robotics from leading global innovators.",
            imageUrl: "https://images.unsplash.com/photo-1581092580497-c3a25d43907c?q=80&w=2070&auto=format&fit=crop",
        },
    ];
    ...
    return (
        <>
            {/* --- Styles --- */}
            {/* We are including the styles directly in the component for simplicity.
                This uses a standard <style> tag, which is a straightforward way 
                to scope styles without needing a separate CSS file.
            */}
            <style>{`
                ...
                .section-header h1 span {
                    /* The light blue color, matching your grid animation */
                    color: #64B4FF; 
                ...
                .event-card {
                    ...
                    border: 1px solid rgba(100, 180, 255, 0.2); /* Subtle blue border */
                    border-radius: 15px;
                    overflow: hidden;
                ...
                .event-date {
                    ...
                    font-size: 0.9rem;
                    font-weight: 700;
                    color: #64B4FF; /* Light blue accent */
                    margin-bottom: 15px;
                }
