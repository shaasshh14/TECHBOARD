...
const Header = () => {
  ...
  return (
    <header
      className={`site-header-new ${isScrolled ? "scrolled" : ""} ${
    ...
    >
      ...
      <nav className={`header-nav-center ${isMenuOpen ? "active" : ""}`}>
        ...
        <Link to="/" className="nav-link" onClick={closeMenu} data-aos="fade-down"
            data-aos-easing="linear"
        ...
        <Link to="/events" className="nav-link" onClick={closeMenu} data-aos="fade-down"
            data-aos-easing="linear"
            data-aos-duration="1700">
          <svg
            className="nav-icon"
        ...
        <Link to="/gallery" className="nav-link" onClick={closeMenu} data-aos="fade-down"
            data-aos-easing="linear"
            data-aos-duration="1700">
          <svg
            className="nav-icon"
        ...
        <Link to="/team" className="nav-link" onClick={closeMenu} data-aos="fade-down"
            data-aos-easing="linear"
            data-aos-duration="1700">
          <svg
            className="nav-icon"
        ...
        {/* MOVED: The "Contact Us" button is now the last item in the nav */}
        <Link to="/contact" className="cta-button" onClick={closeMenu} data-aos="fade-down"
        data-aos-easing="linear"
      ...
      {/* The old header-cta-right div is now removed */}
