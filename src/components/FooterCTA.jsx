...
const Footer = () => {
  return (
    ...
    <footer className="bg-[#0d0d14] text-gray-300 py-12">
          ...
          <div>
            ...
            <div className="flex items-center justify-between mt-6">
              ...
              <div className="flex space-x-4">
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="p-2 bg-[#1a1a26] rounded-lg hover:bg-[#0077b5] transition">
                ...
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="p-2 bg-[#1a1a26] rounded-lg hover:bg-pink-500 transition">
                  <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-5 h-5">
                ...
                <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="p-2 bg-[#1a1a26] rounded-lg hover:bg-sky-400 transition">
                  <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-5 h-5">
                    <title>X</title>
